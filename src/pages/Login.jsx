    ...
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="max-w-md w-full space-y-8 bg-white p-6 sm:p-8 lg:p-10 rounded-[2.5rem] shadow-xl shadow-slate-200/50 border border-slate-100">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl sm:text-3xl font-black text-slate-800 tracking-tight pt-4">Welcome Back</h2>
          <p className="text-slate-500 font-medium text-sm sm:text-base">Please enter your details to sign in</p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          >
            {loading ? <Loader2 className="animate-spin" /> : (
              <>Sign In <ArrowRight size={18} sm:size={20} /></>
            )}
          </button>
        </form>
